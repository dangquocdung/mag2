                        ...
                        <ul>
                            @foreach($children[$element] as $sub_key => $subElements)
                                <li class="collapsed" id="node_sub_{{ $sub_key }}">
                                    <input type="checkbox" class="hrv-checkbox" id="checkSelect_sub{{ $sub_key }}" name="flags[]" value="{{ $flags[$subElements]['flag'] }}" @if (in_array($flags[$subElements]['flag'], $active)) checked @endif>
