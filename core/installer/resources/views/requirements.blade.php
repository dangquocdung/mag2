...
@section('template_title')
    {{ trans('core.installer::installer.requirements.templateTitle') }}
@endsection

@section('title')
    <i class="fa fa-list-ul fa-fw" aria-hidden="true"></i>
    {{ trans('core.installer::installer.requirements.title') }}
@endsection
...
@section('container')
    ...
    @if (!isset($requirements['errors']) && $phpSupportInfo['supported'] )
        <div class="buttons">
            <a class="button" href="{{ route('installers.environment') }}">
                {{ trans('core.installer::installer.permissions.next') }}
