        ...
        <div class="flexbox-annotated-section">
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group">
                        <label class="text-title-field"
                               for="show_on_front">{{ trans('core.setting::setting.general.show_on_front') }}
                        </label>
                        <div class="ui-select-wrapper">
                            <select name="show_on_front" class="ui-select" id="show_on_front">
                                <option value="">{{ trans('core.setting::setting.general.select') }}</option>
                    ...
                    <div class="form-group">
                        <div class="mt5">
                            ...
                            <label><input type="checkbox" class="hrv-checkbox" value="1"
                                          @if (setting('optimize_page_speed_enable')) checked @endif name="optimize_page_speed_enable"> {{ trans('core.setting::setting.general.optimize_page_speed') }} </label>
                        </div>
                    </div>
                        ...
                        <div class="ui-select-wrapper">
                            <select name="default_admin_theme" class="ui-select" id="default_admin_theme">
                                @foreach(Assets::getThemes() as $theme => $path)
                                    <option value="{{ $theme }}" @if (setting('default_admin_theme', config('core.base.general.default-theme')) === $theme) selected @endif>{{ studly_case($theme) }}</option>
                                @endforeach
                            </select>
                            <svg class="svg-next-icon svg-next-icon-size-16">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
