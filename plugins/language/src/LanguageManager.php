...
class LanguageManager
{
     ...
     * @var array
     */
    protected $active_language_select = ['*'];
     ...
     * @var array
     */
    protected $default_language_select = ['*'];
    ...
    {
        if ($this->active_languages && $this->active_language_select === $select) {
            return $this->active_languages;
        }

        $this->active_languages = $this->languageRepository->getActiveLanguage($select);
        $this->active_language_select = $select;
        return $this->active_languages;
    }
    ...
    public function getDefaultLocaleCode()
    {
        ...
        return array_get($this->supportedLocales, $this->getDefaultLocale() . '.lang_code', config('app.locale'));
    }
    ...
    {
        if ($this->default_language && $this->default_language_select === $select) {
            return $this->default_language;
        }
        $this->default_language = $this->languageRepository->getDefaultLanguage($select);
        $this->default_language_select = $select;
        return $this->default_language;
    }
    ...
    {
        $default_language = $this->getDefaultLanguage(['lang_id']);
    ...
    public function registerModule($screen)
    {
        ...
        config(['plugins.language.general.supported' => array_merge(config('plugins.language.general.supported'), $screen)]);
        return $this;
    }
}
