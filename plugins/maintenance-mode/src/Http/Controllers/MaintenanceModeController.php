...
use Botble\Base\Supports\MaintenanceMode;
...
class MaintenanceModeController extends Controller
{
     ...
     */
    public function postRun(MaintenanceModeRequest $request, BaseHttpResponse $response, MaintenanceMode $maintenanceMode)
    {
